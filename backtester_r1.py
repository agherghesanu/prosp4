"""
Round 1 Backtester Wrapper
===========================
Runs trader_r1.py against all 3 days of Round 1 data and prints summary.

Usage:
    python backtester_r1.py
"""
...
if __name__ == "__main__":
    trader_file = sys.argv[1] if len(sys.argv) > 1 else "trader_r1.py"
    data_dir = "round_1"
